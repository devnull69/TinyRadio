...
public class AntenneBayernStrategy implements SongTitleStrategy {
    private final String url = "https://api.radio.de/info/v2/search/nowplaying?_=1488891339000&apikey=28b7b71da75f78d5811ca9309703b0b12fa8f6bf&numberoftitles=1&station=9123";

    @Override
    public String getSongTitle(HTTPHelper myHttpHelper) {
        String ergebnis = "Unbekannt";

        String bayernJson = myHttpHelper.getHtmlFromUrl(url, "", false, false);
